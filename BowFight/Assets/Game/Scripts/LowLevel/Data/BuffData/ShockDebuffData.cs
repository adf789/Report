...
public struct ShockDebuffData : IBuffData
{
    public uint ID { get; private set; }
    public BuffType Type { get => BuffType.Shock; }
    ...
    public ShockDebuffData(SkillTableData skillData, float value, float currentTime)
    {
        if (skillData == null)
        {
