...
public struct BlindDebuffData : IBuffData
{
    public uint ID { get; private set; }
    public BuffType Type { get => BuffType.Blind; }
    ...
    public BlindDebuffData(SkillTableData skillData, float value, float currentTime)
    {
        if (skillData == null)
        {
