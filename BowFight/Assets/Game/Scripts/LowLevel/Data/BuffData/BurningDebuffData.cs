...
public struct BurningDebuffData : IBuffData
{
    public uint ID { get; private set; }
    public BuffType Type { get => BuffType.Burning; }
    ...
    public BurningDebuffData(SkillTableData skillData, float value, float currentTime)
    {
        if (skillData == null)
        {
